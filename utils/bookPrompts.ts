export const bookPrompts = {
  ...
  recomendacion: (genre: any, theme: any, author:any) => `
    Recomienda 5 libros basados en los siguientes criterios:
    - Género: ${genre}
    - Tema: ${theme}
    - Si tiene alguna preferencia sobre algun autor: ${author}
    - Incluye: Titulo del libro, autor, breve descripcion del libro.
  `,
};
